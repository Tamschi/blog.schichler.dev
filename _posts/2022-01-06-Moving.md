...
Run `bundle` to initialise the lockfile for your blog after running the init script as per the theme instructions.
You should commit this to Git also, to make sure the site always builds reliably.
